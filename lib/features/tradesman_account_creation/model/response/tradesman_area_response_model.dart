class TradesmanAreaResponseModel {
  final String? id;
  final String? user;
  ...
  factory TradesmanAreaResponseModel.fromJson(Map<String, dynamic> json) {
    return TradesmanAreaResponseModel(
      id: json['_id'],
      user: json['user'],
