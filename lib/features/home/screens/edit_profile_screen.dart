  ...
  Widget build(BuildContext context) {
    ...
    final EditProfileController controller = Get.put(
      EditProfileController(
        initialName: tradesmanName,
        initialPhone: tradesmanPhone,
        initialMainTrade: tradesmanSkill,
        initialHomeArea: homeArea,
                              ...
                              Container(
                                ...
                                child: path != null && path.isNotEmpty
                                  ...
                                  onTap: controller.pickProfilePhoto,
                                    ...
                                    : Center(
                                        child: Text(
                                          tradesmanName.isNotEmpty
                                              ? (tradesmanName[0] +
                                                      (tradesmanName.contains(' ')
                                                          ? tradesmanName.split(' ')[1][0]
                                                          : ''))
                                                  .toUpperCase()
                                              : 'TR',
                                          style: GoogleFonts.outfit(
